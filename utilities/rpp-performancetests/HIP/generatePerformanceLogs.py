...
if profilingOption == "NO":
    ...
    log_file_list = [
        "../OUTPUT_PERFORMANCE_LOGS_HIP/BatchPD_hip_pkd3_hip_raw_performance_log.txt",
        "../OUTPUT_PERFORMANCE_LOGS_HIP/BatchPD_hip_pln3_hip_raw_performance_log.txt",
        "../OUTPUT_PERFORMANCE_LOGS_HIP/BatchPD_hip_pln1_hip_raw_performance_log.txt"
        ]
    ...
    RESULTS_DIR = "../OUTPUT_PERFORMANCE_LOGS_HIP"
