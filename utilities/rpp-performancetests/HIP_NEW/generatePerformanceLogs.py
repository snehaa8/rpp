...
parser.add_argument("--case_start", type=str, default="0", help="Testing range starting case # - (0:87)")
parser.add_argument("--case_end", type=str, default="87", help="Testing range ending case # - (0:87)")
...
if caseStart < "0" or caseStart > "87":
    print("Starting case# must be in the 0:87 range. Aborting!")
    exit(0)

if caseEnd < "0" or caseEnd > "87":
    print("Ending case# must be in the 0:87 range. Aborting!")
    exit(0)
