...
int main(int argc, char **argv)
{
    ...
    case 21:
    {
        ...
        if (ip_bitDepth == 0)
            ...
            rppi_resize_f16_pkd3_batchPD_gpu(d_inputf16, srcSize, maxSize, d_outputf16, dstSize, maxDstSize, interpolation_type, outputFormatToggle, noOfImages, handle);
        else if (ip_bitDepth == 2)
            ...
            rppi_resize_u8_f16_pkd3_batchPD_gpu(d_input, srcSize, maxSize, d_outputf16, dstSize, maxDstSize, interpolation_type, outputFormatToggle, noOfImages, handle);
        else if (ip_bitDepth == 4)
    ...
    case 22:
    {
        ...
        if (ip_bitDepth == 0)
            ...
            rppi_resize_crop_f16_pkd3_batchPD_gpu(d_inputf16, srcSize, maxSize, d_outputf16, dstSize, maxDstSize, x1, x2, y1, y2, interpolation_type, outputFormatToggle, noOfImages, handle);
        else if (ip_bitDepth == 2)
