...
int main(int argc, char **argv)
{
    ...
    case 22:
    {
        ...
        if (ip_bitDepth == 0)
            ...
            rppi_resize_crop_f16_pln1_batchPD_gpu(d_inputf16, srcSize, maxSize, d_outputf16, dstSize, maxDstSize, x1, x2, y1, y2, interpolation_type, outputFormatToggle, noOfImages, handle);
        else if (ip_bitDepth == 2)
